...
const professionalExperience: ExperienceItem[] = [{
  ...
  highlights: ['Built predictive models improving customer retention by 25%', 'Designed executive dashboards serving 50+ stakeholders', 'Led cross-functional analytics projects with 5-person teams'],
  ...
  highlights: ['Created 30+ client dashboards with 95% satisfaction rate', 'Automated reporting processes saving 20 hours/week', 'Conducted market analysis supporting $2M investment decisions'],
  ...
  highlights: ['Analyzed user behavior data for 10K+ monthly active users', 'Created financial models for Series A fundraising', 'Contributed to product roadmap through data insights'],
